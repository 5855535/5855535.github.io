...
const obtenerPlantillaProductoAgregado = (id, nombre, precio) => {
...
// Nueva función para generar el mensaje de WhatsApp
const generateWhatsAppMessage = () => {
    let message = 'Hola, estoy interesado en estos productos:\n';
    const allProductsAdded = document.querySelectorAll('.cart-product-added');

    allProductsAdded.forEach(product => {
        const productName = product.querySelector('.cart-product-name').innerText;

        // Agregar solo el nombre del producto al mensaje
        message += `- ${productName}\n`;
    });
